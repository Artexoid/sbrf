...
final class Pay extends Action implements Interfaces\IPay
{
    ...
    ): array
    {
        ...
        $error = static::checkForErrors($response);
        if ($error) {
            return [];
        }
     ...
     * @return bool
     */
    public static function isApprovedPay($extOrderNumber, $redirectUrl = ''): bool
    {
     ...
     * @return bool
     */
    public static function isRegistered($extOrderNumber, $redirectUrl = ''): bool
    {
        $statusResponse = static::getStatus($extOrderNumber);
