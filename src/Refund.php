...
final class Refund extends Action
{
     ...
     * @param string $amount Сумма возврата в копейках
     * @return array
     * @throws Exception
     */
    public static function refund($orderId,$amount): array
    {
        $query = [
     ...
     * @return bool
     */
    public static function isRefunded($extOrderNumber,$redirectUrl = ''): bool
    {
